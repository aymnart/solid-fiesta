...
const ModeSkeleton: React.FC<ModeSkeletonProps> = ({ mode, selected = false, className }) => {
  return (
    <div className={cn("w-32 md:w-36 lg:w-48", className, mode)}>
      <div
        className={cn(
